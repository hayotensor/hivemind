...
from hivemind.dht.protocol_ed25519 import DHTProtocol
from hivemind.dht.storage import DictionaryDHTValue
from hivemind.utils import auth_ed25519
...
async def test_empty_table():
    ...
    protocol = await DHTProtocol.create(
        p2p, DHTID.generate(), bucket_size=20, depth_modulo=5, wait_timeout=5, num_replicas=3, client_mode=True, authorizer=auth_ed25519.AuthorizerBase,
    )
